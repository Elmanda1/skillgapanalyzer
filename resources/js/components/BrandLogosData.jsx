  ...
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1 font-sans select-none">
        ...
        <span className="font-black text-base tracking-tight text-[#1C3F94]">JobStreet</span>
        <span className="text-[9px] text-gray-400 font-semibold ml-0.5">by SEEK</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1.5 font-sans select-none">
        ...
        <span className="font-bold text-base text-gray-900 tracking-tight">LinkedIn</span>
      </div>
    ),
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1 font-sans select-none">
        <svg className="w-5 h-5 text-[#2164f3]" viewBox="0 0 24 24" fill="currentColor">
          <path d="M11.5 2C6.25 2 2 6.25 2 11.5S6.25 21 11.5 21 21 16.75 21 11.5 16.75 2 11.5 2zm2.8 14.5h-2.1v-6h2.1v6zm-1.05-7.2c-.7 0-1.25-.55-1.25-1.25s.55-1.25 1.25-1.25 1.25.55 1.25 1.25-.55 1.25-1.25 1.25z"/>
        </svg>
  ...
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1.5 font-sans select-none">
        ...
        <span className="font-black text-base text-[#4A148C] tracking-tight">kalibrr</span>
      </div>
    ),
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1.5 font-sans select-none">
        ...
        <span className="font-black text-sm text-gray-900 tracking-tight">TECH IN ASIA</span>
      </div>
    ),
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1.5 font-sans select-none">
        ...
        <span className="font-extrabold text-base text-[#00838F] tracking-tight">karir<span className="text-gray-900">.com</span></span>
      </div>
    ),
  },
  {
    ...
    logo: (
      <div className="flex items-center gap-1.5 font-sans select-none">
        ...
        <span className="font-extrabold text-base text-gray-900 tracking-tight">Dealls</span>
      </div>
    ),
  },
];
